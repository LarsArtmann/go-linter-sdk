...
> Resolved (2026-09-09): the auth-free workflow's first verified green run
> landed on `487d254`.
...
> Resolved: the threshold is deliberately 90%, scoped to library packages
> only — documented as a gotcha in `AGENTS.md` (don't "fix" it back to
> `./...`).
