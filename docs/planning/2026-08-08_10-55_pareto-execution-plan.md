...
| --- | ------------------------------------------------------------------------- | ----- | -------- | ------ | --------------------------- | ------------ |
| M1  | Fix 2 bloop warnings + run full quality gate (lint, race, flake check)    | 1%    | Critical | 35m    | TODO_LIST + status §f.1-4   | None ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M2  | Integration test: examples/minimal-linter (build, run, assert exit code)  | 4%    | High     | 30m    | TODO_LIST #1                | M1 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M3  | Integration test: examples/no-go-mod (build, run, assert exit code)       | 4%    | High     | 30m    | TODO_LIST #1                | M1 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M4  | Refactor validateRuleIdentity + RuleMeta.Validate to share logic          | 4%    | High     | 30m    | TODO_LIST #5                | M1 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M5  | Edge-case tests: fuzz NewRuleError nil + errors.Is context propagation    | 4%    | High     | 30m    | TODO_LIST #2-3              | M1 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M6  | Test Deregister during concurrent Run + document snapshot semantics       | 4%    | Medium   | 30m    | TODO_LIST #4                | M1 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M7  | README: add Status callout near top + Quick Start section                 | 20%   | High     | 30m    | status §f.18,21             | None ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M8  | README: data-flow diagram + ASCII fallback for mermaid                    | 20%   | Medium   | 30m    | status §f.19-20             | None ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M9  | README: full consistency audit + API symbol verification                  | 20%   | High     | 45m    | status §f.22-23             | M7, M8 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M10 | Export ErrMissingFields + add RuleErrors helper                           | 20%   | Medium   | 30m    | status §f.14-15, ROADMAP T1 | M1 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M11 | HARVEST pass over 3 most recent 2026-07-* status reports                  | 20%   | Medium   | 30m    | status §f.5,43              | None ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M12 | Annotate 6 older 2026-07-* status reports (resolve numbered items)        | 20%   | Low      | 45m    | status §f.43                | M11 ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M13 | CONTRIBUTING.md: add examples/ directory guidance                         | 20%   | Low      | 15m    | status §f.39                | None ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) || M14 | Registry.Len() + RegisterAll() convenience methods                        | other | Low      | 30m    | status §f.16-17, ROADMAP T1 | M1           |
