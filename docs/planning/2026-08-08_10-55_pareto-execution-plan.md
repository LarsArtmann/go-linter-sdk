...
| --- | ------------------------------------------------------------------------- | ----- | -------- | ------ | ------------------------- | ------------------------------------------------------------------ |
| M1  | Fix 2 bloop warnings + run full quality gate (lint, race, flake check)    | 1%    | Critical | 35m    | TODO_LIST + status §f.1-4 | None ✅ executed 2026-08-08 (see `docs/status/2026-08-08_12-16_*`) |
