...
| actionlint workflow linting                     | 🟢 `FULLY_FUNCTIONAL` | CI `actionlint` job (v1.7.12, official download script) + local `actionlint` clean; catches workflow YAML breakage before push                                                                                                                                                                                             |
| dependabot                                     | 🟢 `FULLY_FUNCTIONAL` | `.github/dependabot.yml` — weekly gomod + github-actions updates                                                                                                                                                                                                                                                         |
| Stranger-test CI job                           | 🟢 `FULLY_FUNCTIONAL` | Clean-dir, proxy-only `go get @latest` + build + run of a hello-linter; tests the published artifact exactly as pkg.go.dev users get it                                                                                                                                                                                   |
